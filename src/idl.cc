    ...
    )
{
  ...
  if (hash_identifier
    ...
    auto full_name = parser->root_struct_def_->defined_namespace
      ->GetFullyQualifiedName(parser->root_struct_def_->name);
...
static void add_symbol_table(py::module &m, const std::string &name) {
  ...
  py::class_<TT>(m, (name+"Table").c_str())
    ...
    .def("__iter__", [](const TT &self) {
        ...
        RETPOL_REFINT)
    .def("__reversed__", [](const TT &self) {
        return py::make_iterator(self.vec.rbegin(), self.vec.rend()); },
        RETPOL_REFINT)
    .def("count", [](const TT &self, const IT *value) {
        return std::count(self.vec.begin(), self.vec.end(), value); })
    .def("index", [](const TT &self, const IT *value) {
...
PYBIND11_MODULE(idl, m) {
    ...
    py::enum_<fb::BaseType>(m, "BaseType")
      #define FLATBUFFERS_TD( \
          ENUM, IDLTYPE, CTYPE, JTYPE, GTYPE, NTYPE, PTYPE, RTYPE) \
    ...
    py::class_<fb::Namespace>(m, "Namespace")
      .def(py::init<>())
      .def("__repr__", [](const fb::Namespace &self) {
          std::stringstream repr;
          repr << "<Namespace: [";
    ...
    py::class_<fb::Definition>(m, "Definition")
      .def(py::init<>())
      .def("__repr__", [](const fb::Definition &self)
      ...
      .def_readonly("defined_namespace",
          &fb::Definition::defined_namespace, RETPOL_REFINT)
    ...
    py::class_<fb::Type>(m, "Type")
      .def(py::init<>())
      .def("__eq__", [](const fb::Type &self, const fb::Type &other)
      ...
      .def_property_readonly("inline_alignment", [](fb::Type &self)
          { return fb::InlineAlignment(self); })
      .def_property_readonly("is_struct", [](fb::Type &self)
          { return fb::IsStruct(self); })
      ;
    ...
    py::class_<fb::FieldDef, fb::Definition>(m, "FieldDef")
      .def(py::init<>())
      .def("__repr__", [](const fb::FieldDef &self)
      ...
      .def_readonly("nested_flatbuffer",
          &fb::FieldDef::nested_flatbuffer, RETPOL_REFINT)
    ...
    py::class_<fb::StructDef, fb::Definition>(m, "StructDef")
      .def(py::init<>())
      .def("__repr__", [](const fb::StructDef &self)
    ...
    py::class_<fb::EnumDef, fb::Definition>(m, "EnumDef")
      .def(py::init<>())
      .def("__repr__", [](const fb::EnumDef &self)
    ...
    py::class_<fb::Parser>(m, "Parser")
      ...
      .def_readonly("root_struct_def",
          &fb::Parser::root_struct_def_, RETPOL_REFINT)
      ...
      .def_readonly("included_files",
          &fb::Parser::included_files_, RETPOL_COPY)
      ...
      .def_readonly("known_attributes",
          &fb::Parser::known_attributes_, RETPOL_COPY)
      ...
      .def_readonly("current_namespace",
    ...
    // Functions
    m.def("parse_file", &parse_file, RETPOL_TAKEOWN,
        "source_filename"_a,
